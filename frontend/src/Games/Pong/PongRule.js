    ...
    render() {
      ...
      return (
        <Modal isOpen={isOpen} close={close} footerBtn={close} footerBtnName="close">
          <h1>게임 방법</h1>
          <p>GGAME의 Ping Pong Game은 <img src={v} alt='v'></img>와 <img src={up} alt='up'></img>로 Paddle을 위,아래로 움직일 수 있어요!</p>
          <p>라운드는 총3라운드로 구성되어 있으며 1/2라운드에서는 컴퓨터와 대결해서 해당 점수를 먼저 얻으면 다음 라운드로 넘어갈 수 있어요!</p>
