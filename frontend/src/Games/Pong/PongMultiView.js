...
class PongMultiView extends Component {
  constructor(
  ...
  componentDidMount() {
    ...
    this.props.socket.on("receive data", (data) => {
      this.state.other_dir = data;
    });
  ...
  movePlayer() {
    this.props.socket.emit("send data", this.state.direction);
    ...
    // if (this.state.other_dir == 0) { //위로
    //   this.players[1].pos.y -= 10;
    // } else if (this.state.other_dir == 1) { //아래로
    //   this.players[1].pos.y += 10;
    // }
  }
